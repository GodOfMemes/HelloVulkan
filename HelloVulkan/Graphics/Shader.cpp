...
VkResult Shader::Create(VkDevice device, const char* fileName)
{
...
size_t Shader::CompileShaderFile(const char* file)
{
...
std::string Shader::ReadShaderFile(const char* fileName)
{
	...
	while (code.find("#include ") != code.npos)
	{
		...
		const std::string name = SHADER_DIR + code.substr(p1 + 1, p2 - p1 - 1);
...
size_t Shader::CompileShader(glslang_stage_t stage, const char* shaderSource)
{
...
void Shader::PrintShaderSource(const char* text)
{
	int line = 1;
