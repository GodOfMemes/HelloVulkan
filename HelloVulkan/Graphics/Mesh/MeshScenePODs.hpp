...
#define MAX_SKINNING_BONES 4
#define MAX_SKINNING_MATRICES 100

// Skinning vector with int elements
using iSVec = std::array<int, MAX_SKINNING_BONES>;

// Skinning vector with float elements
using fSVec = std::array<float, MAX_SKINNING_BONES>;
...
{
	std::vector<DefaultVertexData> vertices_ ;
	...
	std::vector<DefaultVertexData> preSkinningVertices_ ; // Subset of vertices_
